<?php
$service_option = cs_get_option('service_option');
$service_radio = cs_get_option('service_radio');
?>
<!-- 服务项目 Start -->
<section class="flat-row card-box">
    <div class="container">
        <div class="section-top mb-30 text-center">
            <h2><?php echo cs_get_option('service_big_title');
                ?></h2>  <span class="mt-10 mb-10">OUR SERVICE</span>
            <p>
                <?php echo cs_get_option('service_big_desc');
                ?>
            </p>
        </div>

        <?php
        if ($service_radio == 'column3') {
            ?>
            <!-- 一行三列 Start -->
